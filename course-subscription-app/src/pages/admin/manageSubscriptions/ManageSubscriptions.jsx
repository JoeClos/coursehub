...
//     console.log("🚀 ~ handleDeleteSubscription ~ subscriptionId:", subscriptionId);
...
//                           onClick={() => {
//                             console.log("🚀 ~ Button clicked ~ sub._id:", sub._id);
...
// import { useCart } from "../../../store/CartContext";
// import AuthContext from "../../../store/AuthContext";
// // import { deleteSubscription } from "../../../utils/api"; // Import the deleteSubscription function
// import "./manageSubscriptions.css";
// import Pagination from "../../../components/Pagination";
// import { useIsMobile } from "../../../utils/useIsMobile";
...
//                           onClick={async () => {
//                             console.log("🚀 ~ Button clicked ~ sub._id:", sub._id);
//                             await deleteSubById(sub._id); // Directly call deleteSubscription
//                           }}
//                           sx={{ marginTop: "10px" }}
//                         >
//                           Delete
...
//                               onClick={() => {
//                                 console.log("🚀 ~ Button clicked ~ sub._id:", sub._id);
//                                  deleteSubById(sub._id); // Directly call deleteSubscription
//                               }}
//                             >
//                               Delete
//                             </Button>
                    ...
                    {learnerSubscriptions.map((sub) => (
                      <Box key={sub._id} sx={{ marginBottom: "10px" }}>
                        ...
                        <Button
                          ...
                          onClick={async () => {
                            console.log("🚀 ~ Button clicked ~ sub._id:", sub._id);
                            await handleDeleteSubscription(sub._id); // Call deleteSubscriptionById directly
                          }}
                          sx={{ marginTop: "10px" }}
                        >
                          Delete
